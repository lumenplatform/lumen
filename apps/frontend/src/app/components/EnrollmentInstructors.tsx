...
export default function Instructors() {
  return (
    <Container>
      <Stack direction="row" spacing={3} sx={{ margin: '2% 0' }} alignItems='center'>
        <Avatar
          alt="Remy Sharp"
        ...
        />
        <Stack>
          <Typography variant="h6" sx={{mb:1}}>Remy Sharp</Typography>
          <Typography variant="subtitle1">1250 learners</Typography>
          <Typography variant="subtitle1">12 courses</Typography>
        </Stack>
      </Stack>

      <Stack direction="row" spacing={3} sx={{ margin: '3% 0' }} alignItems='center'>
        <Avatar
          alt="Kewin Wayne"
        ...
        />
        <Stack >
          <Typography variant="h6" sx={{mb:1}}>Kevin Wayne</Typography>

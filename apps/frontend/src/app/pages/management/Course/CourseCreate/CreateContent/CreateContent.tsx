        ...
        <CardContent>
          <Typography variant="body1" gutterBottom mt={0}>
            ...
            <Box>
              ...
              own energy levels--filming can tire you out and that translates to
              the screen.
            </Box>
            ...
            <Box>
              ...
              is mostly screencasts, film yourself for your introduction. Or go
            ...
            <Box>
              ...
              extra activities or images that you can add in later to cover
              those cuts.
            </Box>
            <Box sx={{ fontWeight: 'bold' }} mt={2}>
              Create audio marks.
            ...
            <Box>
              ...
              tabs in advance. Make on-screen text at least 24pt and use zooming
              to highlight.
            </Box>
          </Typography>
        </CardContent>

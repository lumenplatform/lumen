import { Avatar, Button, Card, CardActions, CardContent, CardHeader, CardMedia, FormControl, Grid, InputLabel, MenuItem, Paper, Select, TextField, Typography } from "@mui/material";
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <Box sx={{
                        ...
                        <TextField required id="objective-1" label="Course title" variant="outlined" />
                        <TextField required id="objective-1" label="Course subtitle" variant="outlined" />
                        <TextField required id="objective-1" label="Course description" variant="outlined" multiline rows={4} />
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <TextField required id="objective-1" label="What is priliminary taught in course?" variant="outlined" />
...
function Promotions() {
    return (
        <Box>
            implement promotion section here
        </Box>
    );
}
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <Box sx={{
                        ...
                        <TextField id="objective-1" label="Welcome Message" variant="outlined" multiline rows={4} />
                        <TextField id="objective-1" label="Congratulations Message" variant="outlined" multiline rows={4} />
                    </Box>

...
The scope should have the name of the module affected (as perceived by person reading changelog generated from commit messages).
...
- **dev-infra**: used for dev-infrastructure related changes
- **docs**: used for docs related changes within the /docs directory of the repo
